...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="source/assets/images/favicon.png">
    <title>Login</title>
    <!-- Custom CSS -->
...
<body>
                        ...
                        <form action="<?= url_to('login') ?>" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit"
                                        class="btn btn-block btn-dark"><?= lang('Auth.loginAction') ?></button>
                                </div>
    ...
    <script src="source/assets/libs/popper.js/dist/umd/popper.min.js "></script>
    <script src="source/assets/libs/bootstrap/dist/js/bootstrap.min.js "></script>
    <!-- ============================================================== -->
    <!-- This page plugin js -->
    <!-- ============================================================== -->
    <script>
