        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="d-flex pt-2">
                        ...
                        <a class="btn btn-square btn-outline-light rounded-circle me-2"
                            href="https://id-id.facebook.com/sman9bdl/" target="_blank"><i
                                class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-square btn-outline-light rounded-circle me-2"
                            href="https://www.youtube.com/@sman9bdl" target="_blank"><i class="fab fa-youtube"></i></a>
                        <!-- <a class="btn btn-square btn-outline-light rounded-circle me-2" href=""><i
                ...
                <div class="col-lg-3 col-md-6 px-lg-5">
                    <a href="https://smalan.sch.id/" target="_blank"><img class="logo"
                            src="<?= base_url('./assets/img/smalan.png') ?>" alt=""
