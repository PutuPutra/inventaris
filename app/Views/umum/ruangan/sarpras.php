...
<div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container">
        <h1 class="display-3 mb-4 animated slideInDown">Ruangan Wakil Kepala Bidang Sarana dan Prasarana</h1>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <a class="btn px-3 mt-auto mx-auto"
                                href="<?= base_url('/ruangan/waka/sarpras/buku') ?>">Selengkapnya</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <p>Fasilitas yang terdapat di SMAN 9 Bandarlampung</p>
                            <a class="btn px-3 mt-auto mx-auto"
                                href="<?= base_url('/ruangan/waka/sarpras/meja') ?>">Selengkapnya</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <p>Fasilitas yang terdapat di SMAN 9 Bandarlampung</p>
                            <a class="btn px-3 mt-auto mx-auto"
                                href="<?= base_url('/ruangan/waka/sarpras/kursi') ?>">Selengkapnya</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <p>Fasilitas yang terdapat di SMAN 9 Bandarlampung</p>
                            <a class="btn px-3 mt-auto mx-auto"
                                href="<?= base_url('/ruangan/waka/sarpras/foto') ?>">Selengkapnya</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <p>Fasilitas yang terdapat di SMAN 9 Bandarlampung</p>
                            <a class="btn px-3 mt-auto mx-auto"
                                href="<?= base_url('/ruangan/waka/sarpras/pena') ?>">Selengkapnya</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <p>Fasilitas yang terdapat di SMAN 9 Bandarlampung</p>
                            <a class="btn px-3 mt-auto mx-auto"
                                href="<?= base_url('/ruangan/waka/sarpras/penggaris') ?>">Selengkapnya</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                        <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                            ...
                            <p>Fasilitas yang terdapat di SMAN 9 Bandarlampung</p>
                            <a class="btn px-3 mt-auto mx-auto"
                                href="<?= base_url('/ruangan/waka/sarpras/ac') ?>">Selengkapnya</a>
                        </div>
                    </div>
                </div>
            </div>
