                                        ...
                                        <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                            <div class="d-md-flex" style="margin-right: 50px;">
                                                <div id="slWrapper" class="parsley-select wd-250 mg-b-0">
                                                    ...
                                                    <select class="form-control select2 wd-300" id="kondisi_kursi"
                                                        name="tingkat" data-placeholder="Choose one"
                                    ...
                                    <div class="wd-300">
                                        <div class="d-md-flex mg-b-30">
                                            <div class="form-group mg-b-0">
                                                ...
                                                <input type="text" name="posisi" class="form-control wd-300"
                                                    placeholder="Masukkan Posisi Juara" required>
                                            </div>
                                            <div class="mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                                <div class="form-group mg-b-0">
                                                    <label>Tahun <span class="tx-danger">*</span></label>
                                                    <input type="text" name="tahun" class="form-control wd-300"
                                                        placeholder="Masukkan Tahun Juara" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="wd-30">
                                        <div class="d-md-flex mg-b-30">
                                            <div class="form-group mg-b-0">
                                                ...
                                                <input type="text" name="peserta" class="form-control wd-300"
