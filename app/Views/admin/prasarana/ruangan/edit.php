            ...
            <div class="inner-content">
                ...
                <div class="custom-fieldset-style mg-b-30">
                    <div class="clearfix">
                        ...
                        <div class="clearfix">
                            <form action="<?= base_url('/ruangan/update') . '/' . $files_ruangan->id_ruangan ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
                                <?= csrf_field(); ?>
                                ...
                                <div class="wd-300">
                                    ...
                                    <div class="d-md-flex mg-b-30">
                                        <div class="form-group mg-b-0">
                                            ...
                                            <input type="text" name="nama_ruangan" class="form-control wd-300" value="<?= $files_ruangan->nama_ruangan; ?>" required>
                                        ...
                                        <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                            ...
                                            <input type="file" name="gambar_ruangan" id="gambar_ruangan" class="form-control wd-300" value="<?= $files_ruangan->gambar_ruangan; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="wd-300">
                                        <div class="d-md-flex mg-b-30">
                                            <div class="form-group mg-b-0">
                                                ...
                                                <input type="text" name="kepala_ruangan" class="form-control wd-300" placeholder="Kepala Ruangan" value="<?= $files_ruangan->kepala_ruangan; ?>" required>
