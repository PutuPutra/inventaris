                                ...
                                <div class="wd-300">
                                    <div class="d-md-flex mg-b-30">
                                        <div class="form-group mg-b-0">
                                            ...
                                            <input type="text" name="ukuran_meja" class="form-control wd-300" placeholder="contoh: 120 x 50 x 75 cm" required>
                                        </div>
                                        <!-- form-group -->
                                    ...
                                    <div class="wd-250">
                                        <div class="d-md-flex mg-b-30">
                                            <div class="form-group mg-b-0 mr-3">
                                                ...
                                                <input type="text" name="serial_number" class="form-control wd-300" placeholder="Nomor Seri" required>
                                            </div>
                                    ...
                                    <div class="wd-250">
                                        <div class="d-md-flex mg-b-30">
                                            <div class="form-group mg-b-0 mr-3">
                                                ...
                                                <input type="number" name="jumlah_meja" id="jumlah_meja" class="form-control wd-300" placeholder="Jumlah Meja" required>
                                            </div>
                                            <div class="d-md-flex" style="margin-right: 50px;">
                                                <div id="slWrapper" class="parsley-select wd-250 mg-b-0">
