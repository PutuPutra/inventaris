            ...
            <div class="inner-content">
                ...
                <div class="custom-fieldset-style mg-b-30">
                    <div class="clearfix">
                        ...
                        <div class="clearfix">
                            <form action="<?= base_url('/meja/update') . '/' . $files_meja->id ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
                                <?= csrf_field(); ?>
                                ...
                                <div class="wd-300">
                                    <div class="d-md-flex mg-b-30">
                                        <div class="form-group mg-b-0">
                                            ...
                                            <input type="text" name="ukuran_meja" class="form-control wd-300" value="<?= $files_meja->ukuran_meja; ?>" required>
                                        </div>

                                        <!-- form-group -->
                                        <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                            <label>Gambar <span class="tx-danger">*</span></label>
                                            <input type="file" name="gambar_meja" class="form-control wd-300" value="<?= $files_meja->gambar_meja; ?>">
                                        </div>
                                        <!-- form-group -->
                                    </div>
                                    <div class="wd-300">
                                                ...
                                                <div class="d-md-flex" style="margin-right: 50px;">
                                                    <div id="slWrapper" class="parsley-select wd-250 mg-b-0">
                                                        ...
                                                        <select class="form-control select2 wd-300" id="kondisi_meja" name="kondisi_meja" data-placeholder="Choose one" data-parsley-class-handler="#slWrapper" data-parsley-errors-container="#slErrorContainer" required>
                                                            <option value="Baik" <?= "Baik" == $files_meja->kondisi_meja ? 'selected' : null ?>>
                                                                Baik</option>
                                                            <option value="Kerusakan Ringan" <?= "Kerusakan Ringan" == $files_meja->kondisi_meja ? 'selected' : null ?>>
                                                                Kerusakan Ringan
                                                            </option>
                                                            <option value="Kerusakan Sedang" <?= "Kerusakan Sedang" == $files_meja->kondisi_meja ? 'selected' : null ?>>
                                                                Kerusakan Sedang
                                                            </option>
                                                            <option value="Kerusakan Berat" <?= "Kerusakan Berat" == $files_meja->kondisi_meja ? 'selected' : null ?>>
                                                                Kerusakan Berat
                                                            </option>
                                                        </select>
