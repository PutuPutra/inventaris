                            ...
                            <tbody style="justify-content: center;" id="bodyTable">
                                <?php foreach ($files_komputer as $f) : ?>
                                    <tr>
                                        ...
                                        <td id="isiTable"><img class="pictures" src="/assets/dokumen/komputer/<?= $f->gambar_komputer; ?>" alt="" width="100px"></img>
                                        </td>
                                        ...
                                        <td id="isiTable">
                                            <div class=" buttons">
                                                <a href="<?= base_url('editLaptop') . '/' . $f->id ?>" class="btn btn-warning">
