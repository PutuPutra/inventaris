            ...
            <div class="inner-content">
                ...
                <div class="custom-fieldset-style mg-b-30">
                    <div class="clearfix">
                        ...
                        <div class="clearfix">
                            <form action="<?= base_url('/kipasAngin/update') . '/' . $files_kipas_angin->id ?>"
                                ...
                                <div class="wd-300">
                                    <div class="d-md-flex mg-b-30">
                                        <div class="form-group mg-b-0">
                                            ...
                                            <input type="text" name="merk_kipas_angin" class="form-control wd-300"
                                                value="<?= $files_kipas_angin->merk_kipas_angin; ?>" required>
                                        </div>

                                        <!-- form-group -->
                                        <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                            <label>Gambar <span class="tx-danger">*</span></label>
                                            <input type="file" name="gambar_kipas_angin" class="form-control wd-300"
                                                value="<?= $files_kipas_angin->gambar_kipas_angin; ?>">
                                        </div>
                                        <!-- form-group -->
                                    </div>
                                    <div class="wd-300">
                                        <div class="d-md-flex mg-b-30">
                                            <div class="form-group mg-b-0">
                                                ...
                                                <input type="text" name="serial_number" class="form-control wd-300"
                                                    value="<?= $files_kipas_angin->serial_number; ?>" required>
                                            </div>
                                            <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                                <div class="d-md-flex" style="margin-right: 50px;">
                                                    <div id="slWrapper" class="parsley-select wd-250 mg-b-0">
                                                        ...
                                                        <select class="form-control select2 wd-300"
                                                            id="kondisi_kipas_angin" name="kondisi_kipas_angin"
                                                            data-placeholder="Choose one"
                                                            data-parsley-class-handler="#slWrapper"
                                                            data-parsley-errors-container="#slErrorContainer" required>
                                                            <option value="Baik"
                                                                <?= "Baik" == $files_kipas_angin->kondisi_kipas_angin ? 'selected' : null ?>>
                                                                Baik</option>
                                                            <option value="Kerusakan Ringan"
                                                                <?= "Kerusakan Ringan" == $files_kipas_angin->kondisi_kipas_angin ? 'selected' : null ?>>
                                                                Kerusakan Ringan
                                                            </option>
                                                            <option value="Kerusakan Sedang"
                                                                <?= "Kerusakan Sedang" == $files_kipas_angin->kondisi_kipas_angin ? 'selected' : null ?>>
                                                                Kerusakan Sedang
                                                            </option>
                                                            <option value="Kerusakan Berat"
                                                                <?= "Kerusakan Berat" == $files_kipas_angin->kondisi_kipas_angin ? 'selected' : null ?>>
                                                                Kerusakan Berat
                                                            </option>
                                                        </select>
