            ...
            <div class="inner-content">
                ...
                <div class="custom-fieldset-style mg-b-30">
                    <div class="clearfix">
                        ...
                        <div class="clearfix">
                            <form action="<?= base_url('penggaris/store') ?>" method="POST"
                                ...
                                <div class="wd-300">
                                    <div class="d-md-flex mg-b-30">
                                        <div class="form-group mg-b-0">
                                            ...
                                            <input type="text" name="merk_penggaris" class="form-control wd-300"
                                                placeholder="Isi sesuai merek pada barang" required>
                                        </div>
                                        <!-- form-group -->
                                        <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                            <label>Gambar <span class="tx-danger">*</span></label>
                                            <input type="file" name="gambar_penggaris" class="form-control wd-300"
                                        ...
                                        <div class="d-md-flex mg-b-30">
                                            ...
                                            <div class="d-md-flex" style="margin-right: 50px;">
                                                <div id="slWrapper" class="parsley-select wd-250 mg-b-0">
                                                    ...
                                                    <select class="form-control select2 wd-300" id="kondisi_penggaris"
                                                        name="kondisi_penggaris" data-placeholder="Choose one"
                                                        data-parsley-class-handler="#slWrapper"
                                                        data-parsley-errors-container="#slErrorContainer" required>
                                                        <option label="Pilih Kondisi"></option>
                                                        <option value="Baik">Baik</option>
                                                        <option value="Patah">Patah
                                                        </option>
                                        ...
                                        <div class="d-md-flex mg-b-30">
                                            <div class="d-md-flex mg-b-30 mr-3">
                                                <div class="form-group mg-b-0">
                                                    ...
                                                    <input type="text" name="panjang_penggaris"
                                                        class="form-control wd-300" placeholder="contoh : 60cm"
                                                        required>
                                                </div>
                                            </div>
