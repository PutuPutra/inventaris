                                ...
                                <div class="wd-300">
                                    <div class="d-md-flex mg-b-30">
                                        <div class="form-group mg-b-0">
                                            ...
                                            <input type="text" name="ukuran_kursi" class="form-control wd-300"
                                                placeholder="Enter Ukuran" required>
                                        </div>
                                        <!-- form-group -->
                                        <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                            <label>Gambar <span class="tx-danger">*</span></label>
                                            <input type="file" name="gambar_kursi" class="form-control wd-300"
                                            ...
                                            <div class="d-md-flex" style="margin-right: 50px;">
                                                <div id="slWrapper" class="parsley-select wd-250 mg-b-0">
                                                    ...
                                                    <select class="form-control select2 wd-300" id="kondisi_kursi"
                                                        name="kondisi_kursi" data-placeholder="Choose one"
