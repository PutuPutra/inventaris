            ...
            <div class="inner-content">
                ...
                <div class="custom-fieldset-style mg-b-30">
                    <div class="clearfix">
                        ...
                        <div class="clearfix">
                            <form action="<?= base_url('kursi/store') ?>" method="POST" enctype="multipart/form-data" data-parsley-validate>
                                <?= csrf_field(); ?>
                                ...
                                <div class="wd-300">
                                    <div class="d-md-flex mg-b-30">
                                        <div class="form-group mg-b-0">
                                            ...
                                            <input type="text" name="ukuran_kursi" class="form-control wd-300" placeholder="Enter Ukuran" required>
                                        </div>
                                        <!-- form-group -->
                                        <div class="form-group mg-b-0 mg-md-l-20 mg-t-20 mg-md-t-0">
                                            <label>Gambar <span class="tx-danger">*</span></label>
                                            <input type="file" name="gambar_kursi" class="form-control wd-300" placeholder="Enter Gambar" required>
                                        </div>
                                        <!-- form-group -->
                                    </div>
                                    <div class="wd-250">
